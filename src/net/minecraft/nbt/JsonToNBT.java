...
public class JsonToNBT {
    ...
    static JsonToNBT.Any joinStrToNBT(String... args) throws Exception
    {
        return nameValueToNBT(args[0], args[1]);
    }

    static JsonToNBT.Any nameValueToNBT(String key, String value) throws Exception
    {
        value = value.trim();
    ...
    private static JsonToNBT.Any getTagFromNameValue(String str, boolean isArray) throws Exception
    {
